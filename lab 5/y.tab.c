...
{
  "$end", "error", "$undefined", "STRING", "NUMBER", "FLOAT", "'\\n'",
...
{
       0,    11,     9,    10,     0,     0,     0,     5,     8,     0,
       1,     2,     0,     0,     0,     0,    12,     3,     4,     6,
       7
};
...
{
       1,     2,     3,    14,    15,    12,    13,    10,     4,     0,
      16,    11,    12,    13,    17,    18,     9,    19,    20
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     9,    10,     7,     8,     0,    11,    -1,
      12,     6,     7,     8,    12,    13,     4,    14,    15
};
...
{
       0,     3,     4,     5,    11,    14,    15,    16,    17,    15,
       0,     6,     7,     8,     9,    10,    12,    16,    16,    17,
      17
};
...
#line 32 "yacc.y"
                 {
        if(attChecker((yyvsp[-2].node).type, (yyvsp[0].node).type, (yyvsp[-2].node).type)) {
            (yyval.node).type = (yyvsp[-2].node).type;
            // calculate logic here
        } else if (attChecker((yyvsp[-2].node).type, (yyvsp[0].node).type, "")) {
        ...
        printf("%s %s\n", (yyval.node).val, (yyval.node).type);
    }
#line 1344 "y.tab.c"
    break;
...
#line 45 "yacc.y"
                 {
        if(attChecker((yyvsp[-2].node).type, (yyvsp[0].node).type, "int") || attChecker((yyvsp[-2].node).type, (yyvsp[0].node).type, "float")) {
            (yyval.node).type = (yyvsp[-2].node).type;
            // calculate logic here
        } else if (attChecker((yyvsp[-2].node).type, (yyvsp[0].node).type, "")) {
            (yyval.node).type = "float";
